...
vim.keymap.set({ "n", "x", "o" }, "f", ts_repeat_move.builtin_f_expr, { desc = "Treesitter: Repeat f movement", expr = true })
vim.keymap.set({ "n", "x", "o" }, "F", ts_repeat_move.builtin_F_expr, { desc = "Treesitter: Repeat F movement", expr = true })
vim.keymap.set({ "n", "x", "o" }, "t", ts_repeat_move.builtin_t_expr, { desc = "Treesitter: Repeat t movement", expr = true })
vim.keymap.set({ "n", "x", "o" }, "T", ts_repeat_move.builtin_T_expr, { desc = "Treesitter: Repeat T movement", expr = true })
